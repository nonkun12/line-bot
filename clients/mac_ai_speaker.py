...
Audio capture is kept on the Mac. The server remains responsible for STT,
AI Core routing, and TTS. This client deliberately requires explicit recording
length and an internal key; it never edits the repository or runs shell commands
received from the AI.
"""
...
except ImportError as exc:  # pragma: no cover - exercised on an unconfigured Mac
    sd = None

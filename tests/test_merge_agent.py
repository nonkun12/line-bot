...
def test_merge_approved_pr_merges_and_rechecks_state(monkeypatch):
    ...
    responses = iter([
        FakeResponse(200, {"number": 42, "state": "open", "merged": False, "html_url": "https://github.com/x/y/pull/42"}),
        FakeResponse(200, {"merged": True, "sha": "merge123", "message": "Pull Request successfully merged"}),
        FakeResponse(200, {"number": 42, "state": "closed", "merged": True, "merge_commit_sha": "merge123", "html_url": "https://github.com/x/y/pull/42"}),
    ])
